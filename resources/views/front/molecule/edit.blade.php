...
@section('molecule.content')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="tab-content" id="v-pills-tabContent">
                                                @include('front.molecule._partials.main-tab-content')
                                                @include('front.molecule._partials.overview-tab-content')
                                                @include('front.molecule._partials.sysytemview-tab-content')
                                                @include('front.molecule._partials.gene-tab-content')
                                                @include('front.molecule._partials.transcript-tab-content')
                                                @include('front.molecule._partials.protein-tab-content')
                                                @include('front.molecule._partials.interactions-tab-content')
                                                @include('front.molecule._partials.reagents-tab-content')
                                                @include('front.molecule._partials.references-tab-content')
                                            </div>
                                        </div>
                                    </div>
    ...
    @include('front.molecule._partials.molecule-modals')
