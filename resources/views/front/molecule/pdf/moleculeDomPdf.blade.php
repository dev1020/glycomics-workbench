...
<header>
    <div style="text-align: left;padding-left: 50px;width:45%;float:left;padding-bottom:10px ;">
        Molecule - <strong>{{ucwords($molecule->molecule_main_title)}}</strong>
    </div>

    <div style="text-align: right;padding-right: 50px;width:45%;float:left;padding-bottom:10px ;">
...
<footer>
    ...
    <table border=0 style="border: none !important;border-collapse:collapse;width:100%">
        <tr>
            <td style="width:70%"> </td>

            <td style="width:30%; text-align: right;padding-right: 30px"> <strong><a style="text-decoration: none;" target="_blank" href="{{url('/')}}">{{config('app.name')}}</a></strong></td>
        </tr>
    ...
    <div class="container molecule-show">
        ...
        <ol class="toc-list" role="list">
            ...
            <li>
                ...
                <ol role="list" class="sublist" type="i">
                    <li><a href="#molecule_clinical_significance"><span class="title">Clinical Significance</span></a></li>
        ...
        <!-- Author's Additional Insights1 -->
        <div class="card mb-3">

            <div class="moleculeImage" style="display: block;width:40%;float: left">
                <!--<img src="{{$molecule->molecule_image}}" style="height:200px ">-->
                <img src="{{asset($molecule->molecule_image)}}" style="height:200px ">{{--For Production Server use this--}}

            </div>
            <div class="comment" style="display: block;width:40%;float: left">
                <div class="card-body">
                    <h5 class="card-title">Comment With Reference :</h5>
                    <div class="card-text">
                        {!! $molecule->molecule_comment !!}</div>
        ...
        <div class="card mb-3">
            <div class="card-body">
                <h5 class="card-title" id="molecule_clinical_significance">Clinical significance</h5>
                <div class="card-text">{!! $molecule->molecule_clinical_significance !!}</div>
            </div>
        </div>
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <div class="card-text">
                    <ul>
                        <li><strong>Glycosylation:</strong> {!! ucwords(($molecule->molecule_protein_glycosylation ==='dont' ) ? 'Don\'t Know':$molecule->molecule_protein_glycosylation) !!}</li>
                        <li><strong>Phosphorylation:</strong>{!! ucwords(($molecule->molecule_protein_phosphorylation ==='dont' ) ? 'Don\'t Know':$molecule->molecule_protein_phosphorylation) !!}
                        </li>
                        <li><strong>Sulfation:</strong> {!! ucwords(($molecule->molecule_protein_sulfation ==='dont' ) ? 'Don\'t Know':$molecule->molecule_protein_sulfation) !!}
                        </li>
                        <li><strong>Nitrosylation:</strong> {!! ucwords(($molecule->molecule_protein_nitrosylation ==='dont' ) ? 'Don\'t Know':$molecule->molecule_protein_nitrosylation) !!}
                        </li>
                    </ul>
        ...
        <div class="card mb-3">
            <div class="card-body">
                <h5 class="card-title" id="molecule_drug_small_molecules">Small molecule inhibitors</h5>
        ...
        <div class="card mb-3">
            <div class="card-body">
                <h5 class="card-title" id="molecule_assay_methodid">Assay method ID:</h5>
                <div class="card-text">
                    <div style="text-align: left;padding-left: 50px;width:45%;float:left;padding-bottom:10px ;">
                        Method ID - <strong>{{($molecule->moleculeAssay !==null) ? $molecule->moleculeAssay->assay_method_id : ''}}</strong>
                    </div>

                    <div style="text-align: left;padding-right: 50px;width:45%;float:left;padding-bottom:10px ;">
                        Method Name - <strong>{{($molecule->moleculeAssay !==null)? $molecule->moleculeAssay->assay_method_name : ''}}</strong>
                    </div>
                </div>
            </div>
        </div>
