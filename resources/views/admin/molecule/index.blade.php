                        ...
                        <table class="table table-striped table-responsive table-hover">
                            ...
                            @foreach($molecules as $molecule)
                                <tr>
                                    ...
                                    <td data-label="Meta Keywords">{{ $molecule->molecule_author ?: "(blank)" }}</td>
                                    <td data-label="Meta Description">{{ $molecule->molecule_reviewers ?: "(blank)" }}</td>
                                    <td data-label="Slug">{{ $molecule->molecule_gw_id ?: "(blank)" }}</td>
                                    <td data-label="Slug">{{ $molecule->molecule_status ?: "(blank)" }}</td>
