            ...
            <div class="content-side content-side-full">
                <ul class="nav-main">
                    <li class="nav-main-item">
                        <a class="nav-main-link{{ request()->is('dashboard') ? ' active' : '' }}" href="<?= url('/admin/dashboard')?>">
                    ...
                    <li class="nav-main-item{{
                        ...
                        <ul class="nav-main-submenu">
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('*roles*') ? ' active' : '' }}" href="<?= url('/admin/roles')?>">
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('*users*') ? ' active' : '' }}" href="<?= url('/admin/users')?>">
                    ...
                    <li class="nav-main-item{{
                        ...
                        <ul class="nav-main-submenu">
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('*roles*') ? ' active' : '' }}" href="<?= url('/admin/pages/create')?>">
                                    <span class="nav-main-link-name">New Page</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
                    ...
                    <li class="nav-main-item{{
                        (request()->is('*molecules*')) ? ' open' : ''
                        }}">
                        <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                           aria-expanded="true" href="#">
                            <i class="nav-main-link-icon fa fa-sticky-note"></i>
                            <span class="nav-main-link-name">Molecules</span>
                        </a>
                        <ul class="nav-main-submenu">
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('*molecules*') ? ' active' : '' }}" href="<?= url('/admin/molecules/')?>">
                                    <span class="nav-main-link-name">All Molecules</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('molecules*') ? ' active' : '' }}"
                                   href="<?= url('/admin/molecules/assay')?>">
                                    <span class="nav-main-link-name">Assay Methods</span>
                                </a>
                            </li>
                    ...
                    <li class="nav-main-item{{ request()->is('vehicles*') ? ' open' : '' }}">
                        ...
                        <ul class="nav-main-submenu">
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('*sliders*') ? ' active' : '' }}"
                    ...
                    <div class="dropdown-menu dropdown-menu-end p-0" aria-labelledby="page-header-user-dropdown">
                        ...
                        <div class="p-2">
                            ...
                            <a class="dropdown-item" href="<?= url('/admin/change-password') ?>">
                                <i class="far fa-fw fa-file-alt me-1"></i> Change Password
                            </a>
        ...
        <div class="content py-0">
            <div class="row fs-sm">
                <div class="col-sm-6 order-sm-1 text-center text-sm-start">
                    <a class="fw-semibold" href="{{url('/')}}" target="_blank">{{config('app.name')}}</a> &copy;
