        ...
        <div class="card">
            <div class="card-header d-flex flex-row align-items-center justify-content-between">
                <ol class="breadcrumb m-0 p-0">
                    ...
                    <li class="breadcrumb-item">@lang('Edit Slider') #{{$slider->id}}</li>
                </ol>
            </div>
            <div class="card-body">
                <form action="{{ route('sliders.update', compact('slider')) }}" method="POST" class="m-0 p-0" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="card-body">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="author" id="author" class="form-control"
                                   value="{{@old('author', $slider->author)}}" required/>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="topic" id="topic" class="form-control"
                                   value="{{@old('topic', $slider->topic)}}" required/>
                            @if($errors->has('topic'))
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="read_more_url" id="read_more_url" class="form-control"
                                   value="{{@old('read_more_url', $slider->read_more_url)}}" required/>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="slider_visible" id="slider_visible" class="form-control form-select" required>
                                ...
                                @foreach(["yes" => "Yes", "no" => "No"] as $value => $label )
                                    <option
                                        value="{{ $value }}" {{ @old('slider_visible', $slider->slider_visible) == $value ? "selected" : "" }}>{{ $label }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="card-footer">
                        <div class="d-flex flex-row align-items-center justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">@lang('Update Slider')</button>
                        </div>
                    </div>
                </form>
            </div>
