        ...
        <div class="card">
            <div class="card-header d-flex flex-row align-items-center justify-content-between">
                <ol class="breadcrumb m-0 p-0">
                    ...
                    <li class="breadcrumb-item">@lang('Edit Page') #{{$page->id}}</li>
                </ol>
            </div>
            <div class="card-body">
                <form action="{{ route('pages.update', compact('page')) }}" method="POST" class="m-0 p-0">
                    @method('PUT')
                    @csrf
                    <div class="card-body">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="page_layout" id="page_layout" class="form-control form-select" required>
                                ...
                                @foreach(["blank-page" => "Blank", "sidebar-left" => "Left Sidebar","sidebar-right" => "Right Sidebar","home" => "Home layout"] as $value => $label )
                                    <option
                                        value="{{ $value }}" {{ @old('page_layout', $page->page_layout) == $value ? "selected" : "" }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="meta_keywords" id="meta_keywords" class="form-control"
                                   value="{{@old('meta_keywords', $page->meta_keywords)}}" required/>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="body" id="body" class="tinymce-editor form-control"
